...
class User_Manager(BaseUserManager):
	...
	def _create_user(self, name, email, roll_number=None, department=None, course=None, contact=None, year_of_passing=None, placed_company=None, package=None, offer_type=None, password=None, **extra_fields):
		...
		user = self.model(name=name, roll_number=roll_number, email=email, department=department, course=course, contact=contact, year_of_passing=year_of_passing, placed_company=placed_company, package=package, offer_type=offer_type, **extra_fields)
	...
	def create_superuser(self, name, email, password=None, **extra_fields):
		...
		return self._create_user(name, email, roll_number=None, department=None, course=None, contact=None, year_of_passing=None, placed_company=None, package=None, offer_type=None, password=password, **extra_fields)
...
class Users(AbstractUser):
	...
	offer_type = models.CharField(max_length=20, choices=OFFER_TYPE_CHOICES, blank=True, null=True)
...
class PlacementRound(models.Model):
	...
	name = models.CharField(max_length=100, unique=True, verbose_name="Placement Round Name", help_text="Eg. Aptitude, Technical, HR, etc. (must be unique)")
...
class RoundQuestions(models.Model):
	...
	placement_round = models.ForeignKey(PlacementRound, on_delete=models.CASCADE)
