...
class Survey(models.Model):
    topic = models.CharField(max_length=100, verbose_name="Placement Round Name", help_text="Eg. Aptitude, Technical, HR, etc. (must be unique)")

    form = FormField()

    def __str__(self):
        return "Round #{}: {}".format(self.pk, self.topic)
...
class SurveyResponse(models.Model):
    ...
    def __str__(self):
        return "Response #{} for {} by {}".format(self.pk, self.survey, self.user)
