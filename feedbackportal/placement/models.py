...
class Users(AbstractUser):
	...
	course = ChainedForeignKey(Department, chained_field="department", chained_model_field="course", show_all=False, sort=True, on_delete=models.CASCADE, blank=True, null=True,related_name="student_course")
